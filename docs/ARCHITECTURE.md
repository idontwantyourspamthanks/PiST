...
| `src/editor/` | `CodeEditor` (the editor widget: line-number gutter, breakpoint dots, execution-line highlight, error markers, find/replace bar) and `AsmHighlighter` (m68k Motorola syntax, with light and dark colour sets). |
